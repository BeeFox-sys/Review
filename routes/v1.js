 ...
 * @returns {object} 200 - A series of server sent events.
 * @returns {object} 204 - When updates end, the server will send an event with the data `close` to indicate the event stream should be closed. No more events will be sent after this.
 */
